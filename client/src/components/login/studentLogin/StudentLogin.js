      ...
      <div className="grid grid-cols-2">
        ...
        <form
          ...
          <button
            type="button"
            onClick={() => navigate(-1)}
            className="w-32 mt-2 hover:scale-105 transition-all duration-150 rounded-lg flex items-center justify-center text-white text-base py-1 bg-gray-600">
            Back
          </button>
        </form>
      </div>
